...
The `dhruva.model-evidence.v1` envelope contains a content SHA-256. Identical
persisted state and explicit options produce identical bytes.
...
exact benchmark horizon exists. Missing benchmark, stock sessions, or
...
verified adjustment/corporate-action semantics, at least 2,000 sessions, at
least 104 weekly ranking periods, and at least 100 mature member outcomes at
both 20 and 60 sessions. Until those gates are met the result is
