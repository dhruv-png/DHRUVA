...
PUBLIC_CAPABILITY_MATRIX_REVISION: Final = "public-source-review-2026-08-22"
...
PUBLIC_SOURCE_CAPABILITIES: Final = (
    PublicSourceCapability(
        source_id="nse_exchange_monthly_transaction",
        source_name="National Stock Exchange of India",
        official_domain="nseindia.com",
        dataset_report_name="Capital Equity Market - Exchange Monthly Report",
        official_url=(
        ...
        revisions=U,
        historical_depth=(
            "Official links are published from April 2016; completeness is not guaranteed"
        ),
        download_mechanism="One official XLSX per month; annual ZIP links are separately offered",
        automation_status=M,
        ...
        major_blockers=(
            "verified sample contains traded rows, not a complete non-traded listed population",
            "revision and prospective publication history are unknown",
        ),
    ),
    PublicSourceCapability(
        source_id="nse_clearing_monthly",
        source_name="NSE Clearing Limited",
        official_domain="nseindia.com",
        dataset_report_name="Capital Equity Market - Clearing Corporation Monthly Report",
        official_url=(
            "https://www.nseindia.com/static/regulations/segment-wise-historical-reports"
        ),
        daily_ohlcv=N,
        ...
        publication_datetime=U,
        revisions=U,
        historical_depth="Official monthly links are published from April 2016",
        download_mechanism="One official XLSX or ZIP per month",
        automation_status=M,
        manual_download_support=S,
        retention_licensing_clarity=P,
        ...
        major_blockers=("settlement, pay-in, and margin fields do not contain security OHLCV",),
    ),
    PublicSourceCapability(
        source_id="nse_security_wise_price_volume",
        source_name="National Stock Exchange of India",
        official_domain="nseindia.com",
        dataset_report_name="Security-wise Archives (Equities)",
        official_url="https://www.nseindia.com/report-detail/eq_security",
        daily_ohlcv=S,
        delivery_quantity=S,
        trade_count=S,
        series=S,
        ...
        publication_datetime=U,
        revisions=U,
        historical_depth="UI offers 1D through 5Y plus a custom range per selected symbol",
        download_mechanism="One manual CSV query per symbol/series/range",
        automation_status=M,
        manual_download_support=S,
        retention_licensing_clarity=P,
        research_suitability=P,
        ...
        survivorship_suitability=N,
        major_blockers=(
            "symbol-selected history cannot establish the historical all-security universe",
            "ISIN/security id is absent from the displayed schema",
        ),
    ),
    PublicSourceCapability(
