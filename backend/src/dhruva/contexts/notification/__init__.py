"""C8 -- notification bounded context.

Alert rules, delivery channels, deduplication, escalation.

Publishes
---------
AlertRaised, AlertDelivered

Depends on
----------
May import ``reference``, ``marketdata``, ``analytics``, ``intelligence``, ``strategy``,
``risk``, ``trading``, and only through each one's public ``api`` module.
