"""C4 -- intelligence bounded context.

News, sentiment, consensus, explainability, assistant.

Publishes
---------
NewsIngested, SentimentScored, SignalExplained

Depends on
----------
May import ``reference``, ``marketdata``, ``analytics``, and only through each one's public
``api`` module.
